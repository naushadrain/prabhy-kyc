...
import { Flame, Building2, Home, ChevronLeft } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";

export default function HomeInsurancesPage() {
    const navigate = useNavigate();

    const insuranceCards = [
        {
            title: "House Insurance",
            description: "Calculate fire insurance premium for house or residential building.",
            icon: Home,
            path: "/home-insurances/fire-house",
        ...
        },
        {
            ...
            icon: Building2,
            path: "/home-insurances/fire-property",
                ...
                <div className="mb-8">
                    ...
                    <div className="mt-4 flex items-center gap-3">
                        <button
                            ...
                            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-slate-300 bg-white text-black shadow-sm transition hover:bg-slate-100"
                            aria-label="Go back"
                        >
