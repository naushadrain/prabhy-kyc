// CommercialVehicle/comprehensive/pages/CHazardousGoodsPage.tsx
...
export default function CHazardousGoodsPage() {
                ...
                <div className="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-black">
                            Comprehensive Hazardous Goods Premium Details
                        </h1>
                    ...
                    <div className="grid gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <Input
                                ...
                                className={`mt-2 ${errors.goodCarryingCapacity
                                        ? "border-red-500"
                                        : ""
                                    }`}
                            />
