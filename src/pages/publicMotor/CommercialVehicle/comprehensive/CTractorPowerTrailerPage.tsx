// CommercialVehicle/comprehensive/pages/CTractorPowerTrailerPage.tsx
...
const hpOptions = [
    { label: "Up to 15 HP", value: "15" },
    { label: "16 HP to 20 HP", value: "20" },
    { label: "Above 20 HP", value: "21" },
];
...
export default function CTractorPowerTrailerPage() {
    const navigate = useNavigate();

    const [step, setStep] = useState<1 | 2>(1);

    const [horsePowerCapacity, setHorsePowerCapacity] = useState("");
    ...
    const validate = () => {
        ...
        if (!horsePowerCapacity) {
            newErrors.horsePowerCapacity = "Horse power capacity is required";
        }
    ...
    const handleCalculate = async () => {
        ...
        const payload: GetPremiumRequestCV = {
            ...
            is_government: "1",
            good_carrying_capacity: horsePowerCapacity,
        ...
        try {
            ...
            localStorage.setItem(
                "motor.comprehensiveTractorPowerTrailerForm",
                JSON.stringify({
                    categoryId: "11",
                ...
                <div className="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-black">
                            Comprehensive Tractor & Power Trailer Premium Details
                        </h1>
                ...
                <Card className="mb-6">
                    <CardContent className="pt-6">
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <DetailCard
                                label="Horse Power Capacity"
                                value={
                                    hpOptions.find(
                                        (item) =>
                                            item.value === horsePowerCapacity
                                    )?.label || horsePowerCapacity
                                }
                            />
                            ...
                            <DetailCard
                                ...
                                value={`NPR ${fmt(compulsoryExcess)}`}
                            />
    ...
    return (
        <>
            <div className="mb-8 flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-black">
                        Comprehensive Tractor & Power Trailer
                    </h1>

                    <p className="mt-1 text-sm text-muted-foreground">
                        Fill tractor and power trailer details to calculate
            ...
            <Card className="max-w-5xl">
                <CardContent className="space-y-5 pt-6">
                    <div className="grid gap-5 md:grid-cols-2">
                        <SelectBox
                            label="Horse Power Capacity *"
                            id="horsePowerCapacity"
                            value={horsePowerCapacity}
                            error={errors.horsePowerCapacity}
                            placeholder="Select horse power capacity"
                            options={hpOptions}
                            onChange={(value) => {
                                setHorsePowerCapacity(value);
                                clearError("horsePowerCapacity");
                            }}
                        />
