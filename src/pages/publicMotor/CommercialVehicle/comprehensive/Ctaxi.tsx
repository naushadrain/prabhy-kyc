...
export default function CtaxiPage() {
  ...
  const handleCalculate = async () => {
    ...
    const ccApiValue = selectedCcOption?.apiValue || "900";
  ...
  const premiumRows: PremiumRow[] = [
    {
      key: "suminsured",
      label: "Sum Insured",
      value: getAmountValue("suminsured"),
    },
    {
      key: "premium_amount",
      label: "Basic Premium",
      value: getAmountValue("premium_amount"),
    },
    // {
    //   key: "direct_discount_amount",
    //   label: "Direct Discount Amount",
    //   value: getRootValue("direct_discount_amount"),
    //   type: "less",
    // },
    {
      key: "pa_amount",
      label: "Driver/Passenger",
      value: getAmountValue("pa_amount"),
    },
    {
      key: "tpl_amount",
      label: "Third Party Premium",
      value: getAmountValue("tpl_amount"),
    },
    {
      key: "pool_amount",
      label: "RS/MD/ST",
      value: getAmountValue("pool_amount"),
    },
    {
      key: "taxable_amount",
      label: "Taxable Amount",
      value: getAmountValue("taxable_amount"),
      type: "subtotal",
    },
    {
      key: "vat_amount",
      label: "VAT Amount",
      value: getAmountValue("vat_amount"),
    },
    {
      key: "stamp_duty",
      label: "Stamp Duty",
      value: getAmountValue("stamp_duty"),
    },
    {
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-black">
              Taxi Comprehensive Premium Details
            </h1>
          </div>
        </div>
  ...
  return (
    <>
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-black">
            Taxi Comprehensive Policy
          </h1>

          <p className="mt-1 text-sm text-muted-foreground">
            Comprehensive taxi insurance form.
          </p>
        </div>
      </div>
      ...
      <Card className="max-w-6xl">
        <CardContent className="space-y-5 pt-6">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Enter taxi details to calculate comprehensive premium.
            </p>
          </div>
