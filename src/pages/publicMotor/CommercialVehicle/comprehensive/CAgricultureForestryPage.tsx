// CommercialVehicle/comprehensive/pages/CAgricultureForestryPage.tsx
...
export default function CAgricultureForestryPage() {
        ...
        try {
            ...
            localStorage.setItem(
                ...
                JSON.stringify({
                    ...
                    additional_value: "CV",
                    title: "Agriculture & Forestry Vehicle",
                })
            );

            localStorage.setItem(
                "motor.comprehensiveAgricultureForestryForm",
                JSON.stringify({
                    categoryId: "8",
                    categoryName: "Agriculture & Forestry Vehicle",
                ...
                <div className="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-black">
                            Comprehensive Agriculture & Forestry Premium Details
                        </h1>
    ...
    return (
        <>
            <div className="mb-8 flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-black">
                        Comprehensive Agriculture & Forestry
                    </h1>

                    <p className="mt-1 text-sm text-muted-foreground">
                        Fill agriculture and forestry vehicle details to calculate
            ...
            <Card className="max-w-5xl">
                <CardContent className="space-y-5 pt-6">
                    <div className="grid gap-5 md:grid-cols-2">
                        <InputBox
                            label="Good Carrying Capacity in Ton *"
