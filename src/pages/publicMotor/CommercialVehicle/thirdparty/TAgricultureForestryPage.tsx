// CommercialVehicle/thirdparty/pages/TAgricultureForestryPage.tsx
...
export default function TAgricultureForestryPage() {
    ...
    const handleCalculate = async () => {
        ...
        try {
            ...
            localStorage.setItem(
                "motor.thirdPartyAgricultureForestryForm",
                JSON.stringify({
                    categoryId: "8",
                ...
                <div className="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-black">
                            Agriculture & Forestry Premium Details
                        </h1>
    ...
    return (
        <>
            <div className="mb-8 flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-black">
                        Agriculture & Forestry Third Party
                    </h1>

                    <p className="mt-1 text-sm text-muted-foreground">
                        Fill agriculture and forestry vehicle details to
