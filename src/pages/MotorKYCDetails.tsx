...
export const MotorKYCDetails = () => {
  ...
  const steps = [
    ...
    { number: 4, label: 'Vehicle Details', status: 'completed' },
    { number: 5, label: 'KYC Details', status: 'inProcess' },
  ];
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-8 bg-background">
          ...
          <Dialog open={successModal} onOpenChange={() => {}}>
            <DialogContent className="sm:max-w-md">
              ...
              <div className="py-4 text-center">
                <p className="text-lg">Your motor insurance policy has been submitted successfully.</p>
              </div>
              <DialogFooter>
                <Button className="w-full" onClick={() => { setSuccessModal(false); navigate('/dashboard'); }}>
                  Go to Dashboard
                </Button>
              </DialogFooter>
            </DialogContent>
          ...
          <div className="max-w-5xl mx-auto">
            <Button variant="ghost" className="mb-4 gap-2" onClick={() => navigate('/vehicle-insurance')}>
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between pt-6">
                <Button variant="outline" className="gap-2 text-primary border-primary" onClick={() => navigate('/vehicle-insurance')}>
                  <ChevronLeft className="w-4 h-4" />
                  BACK
                </Button>
                <Button size="lg" className="bg-primary hover:bg-primary/90 px-10" onClick={() => setSuccessModal(true)}>
                  SUBMIT
                </Button>
              </div>
            </div>
