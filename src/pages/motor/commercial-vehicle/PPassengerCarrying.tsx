// CommercialVehicle/comprehensive/PPassengerCarryingPage.tsx
...
const CLASS_ID = "5";
const CATEGORY_NAME = "Commercial Vehicle Passenger Carrying Policy";
const CATEGORY_TITLE = "Passenger Carrying Policy";
const CATEGORY_ROUTE = "/commercial-vehicle/comprehensive/passenger-carrying";
...
export default function PPassengerCarryingPage() {
  ...
  const handleCalculatePremium = async () => {
    ...
    try {
      ...
      localStorage.setItem("motor.selectedCommercialCategoryId", CLASS_ID);
  ...
  const handleSubmitPolicy = async () => {
    ...
    try {
      ...
      console.log("Create Passenger Carrying Policy Payload:", payload);
      ...
      toast.success(
        policyNo
          ? `Passenger carrying policy created successfully. Policy No: ${policyNo}`
          : "Passenger carrying policy created successfully",
      );
      ...
      const msg =
        ...
        error?.message ||
        "Failed to create passenger carrying policy";
  ...
  const renderStep1 = () => (
    <>
      {renderHeader(
        ...
        "Step 1: Fill passenger carrying vehicle details to calculate comprehensive premium.",
      )}
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div>
              ...
              <Input
                ...
                type="text"
                inputMode="numeric"
                placeholder="Enter seats including driver, e.g. 14"
                value={noOfSeats}
                onChange={(e) =>
  ...
  const renderStep2 = () => (
    <>
      {renderHeader(
        ...
        "Step 2: Review passenger carrying comprehensive premium.",
        1,
      )}
  ...
  const renderStep4 = () => (
    <>
      {renderHeader(
        "Review & Submit",
        "Step 4: Review passenger carrying policy details and create policy.",
        3,
      )}
